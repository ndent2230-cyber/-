const dentalTreatmentBundles = [
  ...
  },
  {
    ...
    setName: "スポーツ用マウスピース",
    items: [
      { label: "スポーツ用マウスピース", unitPrice: 22000 },
    ],
  },
  {
    category: "歯周治療",
  ...
  },
  {
    ...
    setName: "ダイレクトボンディング",
    items: [
      { label: "ダイレクトボンディング", unitPrice: 33000 },
    ],
  },
  {
    category: "歯周治療",
    setName: "審美的クラウンレングスニング(歯冠長延長術)",
    items: [
      { label: "審美的クラウンレングスニング(歯冠長延長術)", unitPrice: 330000 },
    ],
  },
  {
    category: "インプラント",
  ...
  },
  {
    ...
    setName: "リッジプリザベーション",
    items: [
      { label: "リッジプリザベーション", unitPrice: 121000 },
    ],
  },
  {
    category: "インプラント",
...
const standaloneTreatments = [
  ...
  { category: "義歯", label: "チタン金属床(総義歯)", unitPrice: 418000 },
  { category: "義歯", label: "コバルト金属床(総義歯)", unitPrice: 363000 },
  { category: "義歯", label: "チタン金属床(４歯以上)", unitPrice: 385000 },
  { category: "義歯", label: "チタン金属床(３歯以下)", unitPrice: 308000 },
  { category: "義歯", label: "コバルト金属床(４歯以上)", unitPrice: 330000 },
  { category: "義歯", label: "コバルト金属床(３歯以下)", unitPrice: 275000 },
  { category: "義歯", label: "ノンクラスプデンチャー(２歯以下)", unitPrice: 110000 },
  { category: "義歯", label: "(義歯)型取り", unitPrice: 5500 },
  { category: "義歯", label: "(義歯)BT", unitPrice: 5500 },
  { category: "義歯", label: "(義歯)TF", unitPrice: 5500 },
  { category: "補綴", label: "ヒューマンブリッジ(１歯欠損)", unitPrice: 407000 },
  { category: "補綴", label: "ヒューマンブリッジ(２歯欠損)", unitPrice: 528000 },
  { category: "補綴", label: "接着ブリッジ", unitPrice: 93500 },
  { category: "補綴", label: "ラミネートベニア", unitPrice: 110000 },
  { category: "その他", label: "ホワイトニング", unitPrice: 38500 },
  { category: "歯周治療", label: "歯周再生療法", unitPrice: 165000 },
  { category: "矯正", label: "矯正(１本のみ)", unitPrice: 110000 },
  { category: "矯正", label: "矯正ゴム交換", unitPrice: 3300 },
  { category: "矯正", label: "矯正リテーナー", unitPrice: 44000 },
  { category: "その他", label: "スポーツ用マウスピース", unitPrice: 22000 },
  { category: "歯周治療", label: "ブルーラジカル", unitPrice: 33000 },
  { category: "補綴", label: "ダイレクトボンディング", unitPrice: 33000 },
  { category: "歯周治療", label: "審美的クラウンレングスニング(歯冠長延長術)", unitPrice: 330000 },
